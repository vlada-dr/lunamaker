...
{
    /**
     * Check if the authenticated user has favorited the present.
    ...
    /**
     * Get the favorites count of the present.
     *
     * @return integer
     */
    ...
    /**
     * Get the users that favorited the present.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
     */
    public function favorited()
    {
        return $this->belongsToMany(User::class, 'favorites', 'present_id', 'user_id')->withTimestamps();
    }

    /**
     * Check if the present is favorited by the given user.
     *
     * @param User $user
     * @return bool
     */
